...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin(
	array(
		'LLL:EXT:ps14_accordion/Resources/Private/Language/locallang_tca.xlf:title',
		'ps14_accordion',
		'ps14-module-accordion'
	),
	'CType',
	'ps14_accordion'
);
...
// Felddefinitionen
$GLOBALS['TCA']['tt_content']['types']['ps14_accordion']['showitem'] = \Ps14\Site\Service\TcaService::getShowitem(
...
// Definition Record
$GLOBALS['TCA']['tt_content']['types']['ps14_accordion']['columnsOverrides']['tx_foundation_elements']['config']['overrideChildTca'] = [
	'columns' => [
		'record_type' => [
			'config' => [
				'items' => [
...
$GLOBALS['TCA']['tt_content']['types']['ps14_accordion']['columnsOverrides']['tx_foundation_elements']['config']['overrideChildTca']['columns']['media']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants'] = \Ps14\Site\Service\TcaService::getCropVariants(
	[
		'default' => [
